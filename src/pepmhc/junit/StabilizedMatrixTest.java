...
public class StabilizedMatrixTest {
    @Test public void testSMM() {
        ...
        assertEquals(167.70654039, mat.computeIC50(Peptide.instance("YWDRNTQIY")).doubleValue(), 1.0E-08);
        assertEquals(1873.0527138, mat.computeIC50(Peptide.instance("QTSYQYLII")).doubleValue(), 1.0E-07);
        assertEquals(11656.012379, mat.computeIC50(Peptide.instance("TSAFNKKTF")).doubleValue(), 1.0E-06);
    }
