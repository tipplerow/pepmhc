...
import pepmhc.engine.net.NetStabParser;
...
public class NetStabParserTest {
    ...
    @Test public void testParse() {
        List<BindingRecord> records = NetStabParser.parse(FILE_NAME);
        ...
        assertEquals(7.61, records.get(0).getAffinity(), 0.01);
        assertEquals(0.50, records.get(9).getAffinity(), 0.01);
