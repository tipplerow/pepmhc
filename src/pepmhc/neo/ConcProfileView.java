...
public final class ConcProfileView {
    ...
    /**
     * Builds neo-peptide and self-peptide concentration profiles from
     * RNA expression data.
     *
     * @param selfReference the reference peptidome: self-peptides
     * generated by antigen processing of germline proteins.
     *
     * @param peptideSource the neo-peptides and self-peptides
     * generated by antigen processing of mutated proteins.
     *
     ...
     */
    public static ConcProfileView build(HugoPeptideTable   selfReference,
                                        PeptideSourceTable peptideSource,
        ...
        for (Map.Entry<HugoSymbol, Expression> entry : expressionProfile.viewEntries()) {
            ...
            Collection<Peptide> selfPeptides = peptideSource.getSelfPeptides(symbol, selfReference);
